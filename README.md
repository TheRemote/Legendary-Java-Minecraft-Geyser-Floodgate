...
<ul>
  <li>April 30th 2024</li>
    <ul>
      <li>Updated default version to 1.20.6 (remember, you never need to wait for updates to change Minecraft versions, just use -e Version=1.20.5)</li>
      <li>Updated Java version to 21</li>
    </ul>
